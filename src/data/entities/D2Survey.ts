...
//new defaults
export const PREVALENCE_CASE_REPORT_FORM_ID = "xMJVm5UaqFh";
export const PREVALENCE_SAMPLE_SHIP_TRACK_FORM_ID = "jvfE4s0gmMl";
export const PREVALENCE_MORTALITY_FOLLOWUP_FORM = "coFThDCw76V";
export const PREVALENCE_MORTALITY_DISCHARGE_CLINICAL_FORM = "ofswUbiH0PD";
...
// export const PREVALENCE_MORTALITY_FOLLOWUP_FORM = "OMrD1jbnhxr";
// export const PREVALENCE_MORTALITY_DISCHARGE_CLINICAL_FORM = "GSmQGiIkUGh";
...
export const AMR_SURVEYS_MORTALITY_TEA_SURVEY_ID_DEC = "Yc0jYZn0lwa";
...
export const AMR_SURVEYS_MORTALITY_TEA_PAT_ID_DEC = "HkBG3DVELBM";
...
export const PREVALENCE_MORTALITY_ARM_FOLLOW_UP_TET = "GRmSkN6YmRO";
